...
export default function AdminLayout({
  ...
  const activeFilterCount =
    selectedColors.length + selectedBrands.length + selectedSizes.length;
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      {/* Sidebar */}
      <aside
        className={`${sidebarOpen ? "w-64" : "w-20"} bg-linear-to-b from-emerald-600 to-teal-600 text-white transition-all duration-300`}
      >
          ...
          <div className="absolute bottom-0 w-64 p-4 border-t border-emerald-700">
            <div className="flex items-center gap-3">
              {userData.avatar ? (
                ...
                <div className="w-10 h-10 bg-white text-emerald-600 rounded-full flex items-center justify-center font-bold">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  {selectedColors.map((colorId) => {
                    ...
                    return (
                      <span
                        key={colorId}
                        className="inline-flex items-center gap-1 px-2 py-1 bg-emerald-100 text-emerald-700 rounded text-xs"
                      >
                        <span
