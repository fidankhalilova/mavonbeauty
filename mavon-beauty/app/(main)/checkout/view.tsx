...
const checkoutSchema = z.object({
    ...
    expiryDate: z.string().regex(/^\d{2}\/\d{2}$/, 'Valid expiry date is required (MM/YY)'),
        ...
        <div className="min-h-screen bg-white py-8">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="mb-8">
                    ...
                    <h1 className="text-3xl md:text-4xl font-light text-gray-800 tracking-wide">Checkout</h1>
                </div>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="bg-white rounded-2xl shadow-sm p-6 border border-emerald-100">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    />
                                    {errors.firstName && (
                                        <p className="text-rose-500 text-sm mt-1">{errors.firstName.message}</p>
                                    )}
                                </div>
                                ...
                                <div>
                                    ...
                                    />
                                    {errors.lastName && (
                                        <p className="text-rose-500 text-sm mt-1">{errors.lastName.message}</p>
                                    )}
                                </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-sm p-6 border border-emerald-100">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h2 className="text-xl font-medium text-gray-800">Shipping Address</h2>
                            </div>
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    />
                                    {errors.address && (
                                        <p className="text-rose-500 text-sm mt-1">{errors.address.message}</p>
                                    )}
                                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        />
                                        {errors.zipCode && (
                                            <p className="text-rose-500 text-sm mt-1">{errors.zipCode.message}</p>
                                        )}
                                    </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-sm p-6 border border-emerald-100">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h2 className="text-xl font-medium text-gray-800">Payment Information</h2>
                            </div>
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    />
                                    {errors.cardNumber && (
                                        <p className="text-rose-500 text-sm mt-1">{errors.cardNumber.message}</p>
                                    )}
                                </div>
                                ...
                                <div>
                                    ...
                                    />
                                    {errors.cardName && (
                                        <p className="text-rose-500 text-sm mt-1">{errors.cardName.message}</p>
                                    )}
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        />
                                        {errors.expiryDate && (
                                            <p className="text-rose-500 text-sm mt-1">{errors.expiryDate.message}</p>
                                        )}
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        />
                                        {errors.cvv && (
                                            <p className="text-rose-500 text-sm mt-1">{errors.cvv.message}</p>
                                        )}
                                    </div>
                                </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-sm p-6 border border-emerald-100">
                            <div className="space-y-3">
                                <label className="flex items-center cursor-pointer">
                                    ...
                                    />
                                    <span className="ml-3 text-gray-700">Save this information for next time</span>
                                </label>
                                ...
                                <label className="flex items-center cursor-pointer">
                                    <input
                                        ...
                                        className="w-5 h-5 rounded border-emerald-300 text-emerald-600 focus:ring-emerald-500"
                                    />
                                    <span className="ml-3 text-gray-700">Subscribe to our newsletter for exclusive offers</span>
                                </label>
                            </div>
                        </div>
                    </div>
