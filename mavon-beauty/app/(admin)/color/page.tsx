...
export default function ColorPage() {
    ...
    const handleUpdate = async () => {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/colors/${editingColor._id}`, {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(formData),
            });
    ...
    return (
        <div>
            ...
            <div className="flex items-center justify-between mb-6">
                <div>
                    <h2 className="text-2xl font-semibold text-gray-800">Color Management</h2>
            ...
            {colors.length === 0 && !loading && (
                <div className="text-center py-12 bg-gray-50 rounded-xl">
                    ...
                    <h3 className="text-lg font-medium text-gray-800 mb-2">No colors yet</h3>
                    <p className="text-gray-600 mb-4">Get started by adding your first color</p>
                    <button
                        onClick={openCreateModal}
                        ...
                        <div className="space-y-4 mb-6">
                            ...
                            <div className="bg-gray-50 rounded-lg p-4">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    ></div>
                                    <div>
                                        <p className="font-semibold text-gray-800">{formData.name || 'Color Name'}</p>
