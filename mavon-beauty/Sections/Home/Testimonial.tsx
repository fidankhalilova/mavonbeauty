...
const TestimonialSection = () => {
    ...
    const testimonials: Testimonial[] = [
        {
            ...
            content: "Thanks for the feedback. We are always looking to improve our product and we would love to look into this issue with you further.",
            rating: 5,
            author: {
                name: "Author",
                position: "CEO",
                image: "https://mavon-beauty.myshopify.com/cdn/shop/files/1_4a0b4a9d-b20a-4502-be43-4a504d45adbe.png?v=1686139245"
            }
        },
        {
            id: 2,
            ...
            author: {
                name: "Author",
                position: "CTO",
                image: "https://mavon-beauty.myshopify.com/cdn/shop/files/2_fbedb4ac-7d26-4c02-826f-49a0925b4316.png?v=1686139244"
            }
        },
        {
            id: 3,
    ...
    return (
        <section className="py-16 bg-[#Fffbf3] mt-10" style={{ fontFamily: '"Montserrat", sans-serif' }}>
