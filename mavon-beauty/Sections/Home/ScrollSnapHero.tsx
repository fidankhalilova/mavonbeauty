...
const BrandInfoSection = () => {
    ...
    return (
        <section className="py-16"  style={{ fontFamily: '"Montserrat", sans-serif' }}>
                ...
                <div className="max-w-7xl mx-auto mb-16 mt-32.5">
                    <div className="flex justify-center items-center gap-8 md:gap-40 flex-wrap">
                        <div className="opacity-50 hover:opacity-100 transition-opacity duration-300">
                            <img src="https://mavon-beauty.myshopify.com/cdn/shop/files/logo-1.png?v=1686138858" alt="Brand 1" width={120} height={120} className="grayscale" />
                        </div>
                        <div className="opacity-50 hover:opacity-100 transition-opacity duration-300">
                            <img src="https://mavon-beauty.myshopify.com/cdn/shop/files/logo-5.png?v=1686138859" alt="Brand 2" width={120} height={120} className="grayscale" />
                        </div>
                        <div className="opacity-50 hover:opacity-100 transition-opacity duration-300">
                            <img src="https://mavon-beauty.myshopify.com/cdn/shop/files/logo-4.png?v=1686138859" alt="Brand 3" width={120} height={120} className="grayscale" />
                        </div>
                        <div className="opacity-50 hover:opacity-100 transition-opacity duration-300">
                            <img src="https://mavon-beauty.myshopify.com/cdn/shop/files/logo-2.png?v=1686138859" alt="Brand 4" width={120} height={120} className="grayscale" />
                        </div>
                        <div className="opacity-50 hover:opacity-100 transition-opacity duration-300">
                            <img src="https://mavon-beauty.myshopify.com/cdn/shop/files/logo-1.png?v=1686138858" alt="Brand 5" width={120} height={120} className="grayscale" />
                        </div>
                    </div>
                </div>
